...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ProblemDetail> handleEmployeeNotFoundException(EmployeeNotFoundException exception, HttpServletRequest request) {
        log.warn("Employee with id={} not found", exception.getId());
    ...
    public ResponseEntity<ProblemDetail> handleDepartmentNotFoundException(DepartmentNotFoundException exception, HttpServletRequest request) {
        log.warn("Department with id={} not found", exception.getId());
        HttpStatus status = HttpStatus.NOT_FOUND;
    ...
    public ResponseEntity<ProblemDetail> handleDepartmentAlreadyExistsException(DepartmentAlreadyExistsException exception, HttpServletRequest request) {
        log.warn("Department with name={} already exists", exception.getName());
